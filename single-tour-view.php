...
include('backend/SingleTourScript.php')
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="row mt-4 mb-4">
            <div class="col"><h1 class='text-center text-white'>Poster </h1>  </div>
        </div>
        ...
        <div class="container">
             <div class="row">
                <div class="col">
                    <h4 class='mt-4 text-center'> Tour Title: <?php echo $data['tour_name']?> </h4>
                    ...
                    <a href='all-tour.php' class='btn btn-info'> Go Back </a>
                </div>
            </div>
        </div>
        </div>
