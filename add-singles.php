        ...
        <div class="container-fluid">
            ...
            <div class="row" id="main" >
                <div class="col-sm-12 col-md-12 well" id="content">
                    <h1> Add Singles & Eps</h1>
                </div>
            </div>
            <form action='backend/AddSingleScript.php' method='POST' enctype="multipart/form-data">
                <div class="row" id="main" >
                ...
                <div class="row" id="main" style='margin-top:20px;'>
                    ...
                    <div class="col-sm-6 col-md-6" id="content">
                    <button type="submit" name='add_single_button' class="btn btn-primary"> Save </button>
                    </div>
                </div>
