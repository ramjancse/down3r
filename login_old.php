...
<head>
    ...
    <!-- ==== Document Title ==== -->
    <title> Login - DJ Central Hub </title>
        ...
        <div class="m-account-w" data-bg-img="assets/img/account/wrapper-bg.jpg">
            <div class="m-account">
                <div class="row no-gutters">
                    <div class="col-md-6">
                        <!-- Login Content Start -->
                        <div class="m-account--content-w" data-bg-img="assets/img/account/content-bg-1.jpg">
                            ...
                            <div class="m-account--form">
                                ...
                                <form action="backend/LoginScript.php" method="POST">
                                    ...
                                    <div class="m-account--actions">
                                        ...
                                        <button type="submit" class="btn btn-rounded btn-info" style="border-radius:0px" name="login_now_btn"> Login </button>
                                    </div>
                                    ...
                                    <div class="m-account--alt">
                                        ...
                                        <a href="register.php" class="btn btn-rounded" style="border-radius:0px"> Register Now</a>
                            </div>
                                    </div>
