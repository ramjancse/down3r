...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <form action='backend/AddSliderScript.php' method='POST' enctype="multipart/form-data">
                <div class="row" id="main" >
                ...
                <div class="row" id="main" style='margin-top:20px;'>
                    ...
                    <div class="col-sm-6 col-md-6" id="content">
                        ...
                        <div id="cover_image" class="form-text">Please upload 1200x450px Media file.</div>
                    </div>
                </div>
                <div class="row" id="main" style='margin-top:20px;'>
                    <div class="col-sm-3 col-md-3" id="content">
                    ...
                    <div class="col-sm-6 col-md-6" id="content">
                    <button type="submit" name='add_slider_button' class="btn btn-primary"> Save </button>
                    </div>
                </div>
