<?php 
  ...
  if(isset($_POST['add_music_button'])){
    ...
    $vdir_upload = '../assets/img/uploads/';
        ...
        if($ext == 'jpg' || $ext == 'JPG' || $ext == 'jpeg' || $ext == 'JPEG'){
          ...
          $sql = "INSERT INTO musics (album_name, artist_name, amazon, deezer, itunes, spotify, description, cover_image,created_at) 
        ...
        if($music_query_run){
          ...
          $created_at = date('Y/m/d H:i:s');
          $sql = "INSERT INTO musics (album_name,artist_name,description, cover_image,created_at) 
