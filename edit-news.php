<?php
  ...
  include('backend/EditNewsScript.php');
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <form action='backend/EditNewsForm.php' method='POST' enctype="multipart/form-data">
            <input type="hidden" name="id" value="<?= $data['id'] ?>">
                <div class="row" id="main" >
                    ...
                    <div class="col-sm-6 col-md-6" id="content">
                        ...
                        value='<?php echo $data['news_title']?>'
                        >
                    </div>
                </div>
                ...
                <div class="row" id="main" style='margin-top:20px;'>
                    ...
                    <div class="col-sm-6 col-md-6" id="content">
                    <button type="submit" name='update_news_button' class="btn btn-primary"> Save </button>
                    <a href="all-news.php" class="btn btn-primary marginY"> Go Back </a>
                    </div>
                </div>
