...
include('backend/AllMusicScript.php')
?>
<!DOCTYPE html>
<html lang="en">
<head>
                    ...
                    foreach($all_music_query_run as $item){
                        ?>
                            <tr>
                                ...
                                <td > 
                                    <a href='/single-music-view.php?id=<?=$item['id']?>' class='btn btn-sm btn-primary'> View </a> 
                                </td>
                                <td> 
                                    <a href="/edit-music.php?id=<?=$item['id']?>" class='btn btn-sm btn-info'> Edit </a>
                                </td>
                                <td> 
                                    <a href="/backend/MusicDeleteScript.php?id=<?=$item['id']?>" class='btn btn-sm btn-danger'> Delete </a>
                                </td>
                            </tr>
                        <?php
                         $i++;
