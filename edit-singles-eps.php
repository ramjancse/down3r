<?php
  ...
  include('backend/EditSingleEpsScript.php');
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <form action='backend/EditSinglesEpsForm.php' method='POST' enctype="multipart/form-data">
                <div class="row" id="main" >
                ...
                <div class="row" id="main" style='margin-top:20px;'>
                    ...
                    <div class="col-sm-6 col-md-6" id="content">
                    <button type="submit" name='update_single_button' class="btn btn-primary marginY"> Update </button>
                    <a href="all-singles-eps.php" class="btn btn-primary marginY"> Go Back </a>
                    </div>
                </div>
